    ...
    return(
        <>
            <dialog id="dialog" className="p-8 rounded-2xl w-[300px]">
               ...
               <Link to='/'><button className="primary-button !w-full duration-150">Back to Dashboard</button></Link>
            </dialog>
            <Header />
            <main>
                <section>
                    ...
                    <form onSubmit={(e)=>{e.preventDefault(); document.getElementById('dialog').showModal()}} className="w-[50%] m-auto flex flex-col items-center gap-5 rounded-2xl bg-slate-200 p-8">
