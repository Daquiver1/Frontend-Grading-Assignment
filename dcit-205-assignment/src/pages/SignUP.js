...
export default function SignUp() {
  return (
    <>
      <Header />
      <section className="flex pt-10 h-screen">
        {/* Left Pane */}
        ...
        {/* Right Pane */}
        <div className="w-full bg-gradient-to-tr from-[#ff80b584] to-[#9189fc8f] lg:w-1/2 flex items-center justify-center">
          <div className="max-w-md w-full p-6 pb-1">
            <h1 className="text-3xl font-semibold mb-6 text-black text-center">
              Sign Up to {webiste.websiteName}
            </h1>
            <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">
              Check your courses,register and file complaints?
            </h1>
