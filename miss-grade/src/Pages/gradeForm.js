  ...
  return (
    <div>
        ...
        <div className="p-4 sm:ml-64">
            ...
            <div className="p-4 h-screen py-12 centent-center">
              <h1 className='text-4xl pb-12 text-center'>Submit the forms bellow to get the grade sorted</h1>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl mx-auto p-6 bg-white rounded-md shadow-md">
                    ...
                    <button type="submit" className="w-full p-4 mt-4 bg-blue-600 text-white rounded">
                        Submit forms
                    </button>
                </form>
