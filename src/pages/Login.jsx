    ...
    <div className='w-full lg:h-[500px] lg:w-[1000px] md:w-[700px] flex flex-col lg:flex-row shadow-sm lg:shadow-lg '>
      <div className='flex-1 flex flex-col items-center border gap-10 relative bg-blue-200/5'>
          <div className='h-[100px] w-[150px]'>
              <img src={large} alt="" className='w-full rounded-full'/>
          </div>

          <div className='flex flex-col justify-center items-center p-4 pt-5'>
            <h1 className='text-2xl'>WELCOM</h1>
            <p className='text-gray-500'>UG's Number One Grade Tracking Sysytem</p>
          </div>
      ...
      <div className='flex-1 border h-full shadow-sm lg:shadow-2xl flex flex-col p-4 gap-5'>
        ...
        <form className='flex flex-col w-full gap-4 p-4 pt-5' onSubmit={Login}>
          <input className='border rounded-lg w-full p-4' type="number" required maxLength={8} aria-label='Student Id' placeholder='Enter your student ID or any Number' onChange={(e)=> setStId(e.target.value)}/>
          <input className='border rounded-lg w-full p-4' maxLength={4} required type="number" aria-label='pin' placeholder='Enter pin or num' onChange={(e)=> setPin(e.target.value)}/>
