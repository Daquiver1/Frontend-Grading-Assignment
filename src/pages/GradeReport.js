...
class GradeReportPage extends React.Component {
  ...
  render() {
    ...
    const gradesData = [
      { year: 2023, semester: 'First', course: 'Physics', grade: 'B' },
      { year: 2023, semester: 'First', course: 'Mathematics', grade: 'A' },
      { year: 2023, semester: 'First', course: 'Computer Science', grade: 'A' },
      { year: 2023, semester: 'First', course: 'Satistics', grade: 'B+' },
      { year: 2023, semester: 'Second', course: 'Advanced Calculus', grade: 'B+' },
      { year: 2023, semester: 'Second', course: 'Programming', grade: 'A' },
      { year: 2023, semester: 'Second', course: 'Aademic writing II', grade: 'A' },
