...
function Login() {
  ...
  return (
      ...
      <Container>
        ...
        <Navbar.Collapse className="justify-content-end">
          <Nav className="justify-content-end">
            ...
            <Nav.Link id='active' as={Link} to="/login">Login</Nav.Link>
    ...
    </Navbar><Container className="d-flex align-items-center justify-content-center" style={{ marginTop: '100px' }}>
          ...
          <Card.Body>
            <Card.Text>
              <>
                ...
                <FloatingLabel controlId="floatingPassword" label="Student Pin">
                  <Form.Control
                    type="password"
