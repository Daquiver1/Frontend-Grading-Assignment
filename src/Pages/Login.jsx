  ...
  return (
    <>
      ...
      <Container fluid className="ms-5">
        <h2 className="text-decoration-underline col-7 mt-5 text-center mb-5">Fill This Form</h2>
        ...
        <Form className="col-7">
          ...
          <Form.Group className="mb-3 form-check">
            <Form.Check type="checkbox" id="exampleCheck1" label="Check me out" />
          </Form.Group>

          <Button href="/dashboard" variant="light" className='btn btn-outline-success' type="submit">Submit</Button>
        </Form>
      </Container>
    </>
  );
