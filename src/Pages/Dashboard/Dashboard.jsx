  ...
  return (
    <main className="bg-gradient-to-r from-blue-900 via-blue-500 to-blue-300 text-white min-h-screen p-4">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {/* Course Count */}
        <div className="bg-blue-500 text-white p-6 rounded-lg shadow-md w-[300px]">
        ...
        {/* Reported Grades */}
        <div className="bg-[#51c851] text-white p-6 rounded-lg shadow-md w-[300px]">
          <div className="flex items-center justify-between">
            <span className="text-5xl font-bold">2</span>
            <FaThermometerThreeQuarters size={40} />
          </div>
          <p className="mt-4 text-sm text-center">Reported Grades</p>
        </div>

        {/* Reply Count */}
        <div className="bg-[#46878b] text-white p-6 rounded-lg shadow-md w-[300px]">
          <div className="flex items-center justify-between">
        ...
        {/* Semesters Count */}
        <div className="bg-purple-600/40 text-white p-6 rounded-lg shadow-md w-[300px]">
          <div className="flex items-center justify-between">
            <span className="text-5xl font-bold">2</span>
            <FaSchool size={40} />
          </div>
        ...
        {/* Passed Count */}
        <div className="bg-green-600/40 text-white p-6 rounded-lg shadow-md w-[300px]">
          <div className="flex items-center justify-between">
            <span className="text-5xl font-bold">2</span>
            <FaCheck size={40} />
          </div>
        ...
        {/* Failed Count */}
        <div className="bg-red-600/40 text-white p-6 rounded-lg shadow-md w-[300px]">
          <div className="flex items-center justify-between">
            <span className="text-5xl font-bold">2</span>
            <FaTimes size={40} />
          </div>
