...
const Dashboard = () => {
  return (
    <>
      ...
      <div>
        <div className='mt-[6rem] mb-[5rem] flex flex-col md:flex-row mx-4 md:mx-8 gap-6'>
          <div className='p-4 ring-1 ring-gray-200 shadow-md rounded-2xl md:flex-[0.2]'>
            <div className='flex items-center'>
              <img src={require('../assets/Heroimg.png')} className='w-8 h-8 rounded-full' alt='profile-pic' />
              <div>
            ...
            <div className='mt-5'>
              ...
              <p className='text-gray-800 text-1xl'>Program:<br /> Computer Science</p>
              <br />
            ...
            <div className='mt-4'>
              <Link to="/GradeReport">
                <p className='text-gray-800 font-semibold text-1xl'>Grades</p>
              </Link>
              <Link to="/Reportform">
                <p className='text-gray-800 font-semibold text-1xl'> Report Form</p>
              </Link>
            </div>
          </div>
          ...
          <div className='flex-1'>
            <div className='flex flex-col md:flex-row gap-7 mt-11 space-x-4'>
              <div className='shadow-md p-3 rounded-2xl w-full md:w-1/2'>
            ...
            <div className='md:flex gap-[-7] mt-11 space-x-4'>
              <div className='flex flex-col md:mr-10 md:ml-0 shadow-md p-7 rounded-2xl w-full md:w-1/2'>
              ...
              <div className='flex flex-col md:ml-0 md:mr-10 shadow-md p-7 rounded-2xl w-full md:w-1/2 '>
                <p>
      ...
      <div>
        {/* This calls the current grade component of the student's current grades. */}
        <CurrentGrades />
      </div>
