      ...
      <div className="container mx-auto mt-8 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {contacts.map((contact) => (
            <div key={contact.id} className="bg-gray-300 p-4 border rounded-md hover:shadow-md">
              <button
                onClick={() => handleContactSelect(contact)}
                className="text-blue-500 hover:underline focus:outline-none font-semibold mb-2 block"
              >
                {contact.name}
              </button>
