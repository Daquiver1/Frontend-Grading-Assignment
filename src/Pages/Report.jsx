  ...
  return (
    <div>
      ...
      <Container fluid className="ms-5">
        <h2 className="text-decoration-underline col-7 mt-5 text-center mb-5">Report your complaint</h2>
        ...
        <Form className="col-7">
          ...
          <Form.Group className="mb-3" controlId="exampleInputStudentID">
          ...
          <Form.Group className="mb-3" controlId="exampleInputPassword1">
            ...
            <Form.Control type="text" placeholder="Type the Lecturer's Name" />
          </Form.Group>

          

          <Button href="/dashboard" variant="light" type="submit" className='btn btn-outline-success'>Submit</Button>
        </Form>
      </Container>
    </div>
  )
