...
return (
    <div className="report" >
      <Navigation />
      <h1 className="acc-head">Grade Report</h1>
      ...
      <Col>
            <h4 className='text-center1'>GPA: {calculateGPA()}</h4>
            <h4 className='text-center1'>Average Performance: {calculateAveragePerformance()}</h4>
          </Col>
