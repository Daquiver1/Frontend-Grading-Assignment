...
function Contact() {
  ...
  const instructors = [
    { id: 1, name: 'Kwame Johnson', email: 'kjohn@example.com',   number: '0243598172' },
    { id: 2, name: 'Yaw Awuku', email: 'yawu@example.com',   number: '0523568712' },
    { id: 3, name: 'Kweku Atom', email: 'katom@example.com', number: '05923512357' },
    { id: 4, name: 'Kwasi Bio', email: 'kbio@example.com',  number: '0559812521' },
  ...
  const renderInstructors = () => {
    ...
    return (
        ...
        </Container><Modal show={showModal} onHide={handleCloseModal}>
