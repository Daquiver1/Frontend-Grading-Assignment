...
import Landing_footer from "./Components/landing-footer";
  ...
  return (
    <div className="px-6 pt-1 shadow-lg">
      ...
      <div className="flex mt-5">
        <img src="/Media_Files/landing-image.jpg" className="w-[630px] h-[415px] mt-4 rounded-lg shadow-lg" />
        <div className="ml-5">
          <p className="ml-3 -mt-[8px] font-bold text-9xl text-amber-950" >Empower</p>
          <p className="ml-3 mt-1 font-bold text-6xl text-zinc-800 ">Your Academics.</p>
