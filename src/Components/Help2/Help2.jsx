  ...
  return (
    <div className="main-container">
      ...
      <div className="inner-container">
        ...
        <div className="text-container">
           <p>Viewing grades, making reports, accessing details and linking to MIS.</p>
        </div>
      </div>
      <div className="inner-container">
        <div className="image-container">
        ...
        <div className="text-container">
           <p>Let us know of any malfunction or challenges you encouter in using this system.</p>
        </div>
      </div>    
    </div>
  )
