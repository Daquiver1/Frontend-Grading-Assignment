...
const Sidebar = () => {
  return (
    <div className="container-fluid">
      <p>
        <button
          className="btn btn-outline-info bi-dash-circle-fill mt-5"
          type="button"
        ...
        <div className="collapse collapse-horizontal" id="collapseWidthExample">
          <div className="card card-body" style={{ width: "400px" }}>
            <div className="bg-white col">
              <div className="m-2">
                <i className="justify-content-center ms-5 ps-4">
                  <svg
                ...
                <br />
                <p className="fs-3 ms-5 ps-4">Gabby Tech1</p>
              </div>
              ...
              <div className="list-group list-group-flush">
                ...
                <a href="/Grade" className="list-group-item py-2">
                  <i>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <span className="fs-5 ps-1" type="submit" href="">
                    Grade
                  </span>
                </a>
                <a href="/GradeForm" className="list-group-item py-2">
                  <i>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <span className="fs-5 ps-1" type="submit">
                    Grade Form
                  </span>
                </a>
                <a href="/Contact" className="list-group-item py-2">
                  <i>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <a className="list-group-item py-2"href="/Help" >
                  <i>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <span type="submit" className="fs-5 ps-1">
                    Help & Support
                  </span>
                </a>
