...
const Hero = () => {
  return (
    <div className="flex flex-col items-center pt-8 px-4 xl:flex-row xl:h-screen xl:p-10 xl:pt-3 gap-2 ">
      <div className="flex items-center justify-center flex-1 w-full xl:w-auto md:ml-[5rem] ">
        <img
      ...
      <div className="flex flex-col flex-1 items-center xl:items-start justify-center text-center xl:text-start space-y-4 xl:mb-4">
        <h1 className="font-bold text-lg xl:text-2xl">
          Welcome to the Missing Grade Reporting System
        </h1>
        <p className="font-normal text-sm xl:text-md text-justify md:mr-[20rem] m-10">
        ...
        <p className="font-normal text-sm xl:text-md md:mr-[20rem] m-10 text-justify">
