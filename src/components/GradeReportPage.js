    ...
    <>
      ...
      <div>
        ...
        <div className="lg:pl-72">
          ...
          <div>
          <strong className='text-3xl pl-10'>Course Grades</strong>
            <p className='text-xl pl-10 pt-8'>1st Semester</p>
            <table style={{ border: '1px solid lightgray', width:'90%', height:'400px', marginLeft:'40px', marginTop: '16px', padding:'40px'}} className='text-center shadow-lg'>
              <tr className='px-22 font-bold'style={{borderBottom: '1px solid lightgray'}}>
                <td>Subject</td>
                <td>Quizzes</td>
                <td>Mid-Sem</td>
                <td>Exam</td>
            ...
            <p className='text-xl pl-10 pt-8'>2nd Semester</p>
            <table style={{ border: '1px solid lightgray ', width:'90%', height:'400px', marginLeft:'40px', marginTop: '16px', padding:'40px'}} className='text-center shadow-lg'>
              <tr className='px-22 font-bold'style={{borderBottom: '1px solid lightgray'}}>
                <td>Subject</td>
                <td>Quizzes</td>
            ...
            <p className='text-xl pl-10 pt-8'>3rd Semester</p>
            <table style={{ border: '1px solid lightgray', width:'90%', height:'400px', marginLeft:'40px', marginTop: '16px', padding:'40px'}} className='text-center shadow-lg'>
              <tr className='px-22 font-bold'style={{borderBottom: '1px solid lightgray'}}>
                <td>Subject</td>
                <td>Quizzes</td>
            ...
            <div className='mx-44 shadow-md' style={{display:'flex' ,border:'1px solid gray', width: '450px', marginTop:'100px', height:'150px', padding:'50px'}}>
                  <div>
                  ...
                  <div style={{paddingLeft:'20px'}}>
                    <p className='font-bold'>
                        ...
                        <p>
                          Click  <a href='/FormPage' style={{color:'blueviolet' }}> here</a> to report
                        </p>
                    </div>
                </div>
