...
import GradeBackground from "../Assets/grade.avif";
...
const GradeReport = () => {
  ...
  return (
    <div className="grade-section-container">
      <div className="grade-background-image-container">
        <img src={GradeBackground} alt="" />
      </div>
