  ...
  const gradeData = {
    level100: {
      sem1: [
        ...
        // Add other courses for Level 100 Semester 1
      ],
      sem2: [
    ...
    level200: {
      sem1: [
        ...
        { courseCode: 'DCIT209', courseName: 'E-Business Architectures', grade: 'A' },
        { courseCode: 'UGRC210', courseName: 'Academic Writing II', grade: 'B+' },
        // Add other courses for Level 200 Semester 1
      ],
      sem2: [
        { courseCode: 'UGRC220', courseName: 'Introduction to African Studies', grade: 'A' },
        { courseCode: 'DCIT202', courseName: 'Mobile App Development', grade: 'B' },
        { courseCode: 'DCIT208', courseName: 'Software Engineering', grade: '-' },
        { courseCode: 'DCIT206', courseName: 'Systems Administration', grade: 'A' },
