  ...
  return (
    <section>
      <div className='background'>
        ...
        {/* Add an attractive sentence */}
        <Container className="text-center mt-3">
          <p className="attractive-sentence">
            Transforming education for a brighter tomorrow. Start your journey with us!
          </p>
          {/* Add a decorated login button */}
          <Link to="/login" className="btn btn-primary decorated-login-btn">
            Login
          </Link>
        </Container>
