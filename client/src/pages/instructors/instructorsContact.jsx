      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
            ...
            <h1 className="headline-text2 text-center">Search for Instructors</h1>
            <input
              type="text"
              name="instructor"
              placeholder="Professor Shebha"
              className="py-2.5 px-1.5 border-0 ring-1 ring-inset ring-gray-200 text-gray-600 rounded-lg shadow-sm w-full focus:ring-2 focus:ring-purple-600 outline-none"
            />
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-gray-900">Dr. Jew Larbi Danquah</h2>
                <p className="mt-4 leading-7 text-gray-600">
                  Senior Lecture for the computer science department and head of AI/ML community.
                </p>
              </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
                ...
                <div className="rounded-2xl bg-gray-50 p-10">
                  <h3 className="text-base font-semibold leading-7 text-gray-900">Join his team</h3>
                  <dl className="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      <dt className="sr-only">Email</dt>
                      <dd>
