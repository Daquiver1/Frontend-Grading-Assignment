...
const LogIn = () => {
  ...
  const studentCredentials = [
    {
      ...
      grade2: {Course: ['DCIT102 COMPUTER HARDWARE FUNDAMENTALS AND CIRCUITS','DCIT104 PROGRAMMING FUNDAMENTALS','MATH122 CALCULUS I ',
      'MATH126 ALGEBRA AND GEOMETRY ','STAT112 INTRODUCTION TO STATISTICS AND PROBABILITY II','UGRC110 ACADEMIC WRITING I'],
      credits:[3,3,3,3,3,3], grading:['B','B+','A', 'B+','A','A']},
      grade3: {Course: ['CBAS210 ACADEMIC WRITING II','DCIT201 PROGRAMMING I','DCIT203 DIGITAL AND LOGIC SYSTEMS DESIGN',
      'DCIT205 MULTI MEDIA AND WEB DESIGN','DCIT207 COMPUTER ORGANIZATION & ARCHITECTURE','MATH223 CALCULUS II'],
      credits:[3,3,3,3,3,3], grading:['A','B+','A', 'A','A','A']},
    },
    {
      email:'11276276',
  ...
  return (
    <div className="w-full sm:h-screen flex flex-row h-auto bg-[#ece3e9]">
        ...
        <div className="flex items-center justify-center h-screen ml-[550px]">
