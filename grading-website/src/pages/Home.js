...
function Home() {
  const backgroundImage = (
    <>
      <img
        src={process.env.PUBLIC_URL + "./images/image1jpeg.jpeg"}
  ...
  const pageContent = (
    <>
      <section className="overview-section">
        ...
        <p>
          Welcome to the Missing Grade Reporting System. This system is designed
          to help you track and report grades that are not recorded in your
          academic profiles.
        </p>
      </section>
      <div className="page-image">
        <img
          ...
          alt="shows-the-page-is-academic"
        />
      </div>
      <div className="card-container">
        <div className="card" style={{ width: 18 + "rem" }}>
          <img
            src={process.env.PUBLIC_URL + "./images/login-image.jpg"}
            class="card-img-top"
            alt="Login image"
          />
          <div class="card-body">
        ...
        <div className="card" style={{ width: 18 + "rem" }}>
          <img
            src={
              ...
              "./images/help and support page image.jpg"
            }
            class="card-img-top"
            alt="Login image"
          />
