...
const Dashboard = () => {
  ...
  return (
    <div className="flex">
      ...
      <h1 style={{ fontSize: '1.5rem' }} className={`text-black origin-left font-medium duration-300 ${!open && "scale-0"}`}>
  UG GRADE REPORT SYSTEM
      ...
      <div className="p-7">
        <h1 className = "text-2xl font-semibold"> Welcome to the your DASHBOARD </h1>
      </div>
