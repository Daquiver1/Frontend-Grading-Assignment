  ...
  return (
    <div>
      ...
      <div className="content">
        ...
        <div id="card-Main">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul>
                <li>
                  Easily report any grades that are not reflected in your
                  academic profile.
                </li>
                <li>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul>
                <li>
                  Connect seamlessly with instructors and academic
                  administration.
                </li>
                <li>
        ...
        <h1 className="Heading2">Our User-Friendly Interface</h1>
