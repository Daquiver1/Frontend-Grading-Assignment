...
const Header = () => {
  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
      ...
      <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Grade Report</a>
      <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Instructors</a>
      <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Help</a>
    </div>
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
      <a href="#" class="text-sm font-semibold leading-6 text-gray-900" style={{marginTop:'10px'}}>Log in </a>
      <a href="#" class="text-sm font-semibold leading-6 bg-blue-500 text-white py-2 px-4 rounded-md ml-1">Sign up</a>
