...
const logout = () => {
  ...
  return (
    <div className={"hidden " +(collapsed? 'w-[100px] ' : "w-[300px] ") + "h-screen duration-300 md:flex flex-col items-center md:sticky md:top-0 border-r shadow"}>
        ...
        <div className='w-full p-1'>
            ...
            <div className='w-full flex flex-col gap-2 mt-5 text-blue-950 text-lg links'>
                <NavLink to='/home' className={'flex whitespace-nowrap items-center gap-2 p-2 ' + (collapsed? "justify-center" : "")} >
                    <DashboardOutlinedIcon fontSize="medium"/>
                    {!collapsed && <span>Student Dashboard </span>}
                </NavLink>
                <NavLink to='/home/courses' className={'flex whitespace-nowrap items-center gap-2 p-2 ' + (collapsed? "justify-center" : "")} >
                    <MenuBookOutlinedIcon fontSize="medium" />
                    {!collapsed && <span>Courses </span>}
                </NavLink>
                <NavLink to='/home/contact' className={'flex whitespace-nowrap items-center gap-2 p-2 ' + (collapsed? "justify-center" : "")} >
                    <CallOutlinedIcon fontSize="medium" />
                    {!collapsed && <span>Contact Instructor</span>}
                </NavLink>
                <NavLink to='/home/missinggradeform' className={'flex whitespace-nowrap items-center gap-2 p-2 ' + (collapsed? "justify-center" : "")} >
                    <ReportGmailerrorredIcon fontSize="medium" />
                    {!collapsed && <span>Report Grade</span>}
                </NavLink>
                <NavLink to='/home/help' className={'flex whitespace-nowrap items-center gap-2 p-2 ' + (collapsed? "justify-center" : "")} >
