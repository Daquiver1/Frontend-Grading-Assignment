        ...
        <header className="fixed right-0 top-0 left-60 bg-yellow-50 py-3 px-4 h-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between">
              ...
              <div className="text-lg font-bold"> Good day, Benjamin</div>
              <Link to="/about">
                <div>
                  <button
                    type="button"
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-3xl p-8 mb-5">
                <h1 className="text-3xl font-bold mb-10">
                  Welcome to Your Academia Wave Dashboard{" "}
                </h1>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-x-2">
                    ...
                    <Link to="/about">
                      <button
                        type="button"
                        className="inline-flex items-center justify-center h-9 px-5 rounded-xl bg-gray-900 text-gray-300 hover:text-black text-sm font-semibold transition"
                      >
                        Check Grades
                      </button>
                    </Link>
                ...
                <div className="grid grid-cols-2 gap-x-20">
                  <div>
                    <h2 className="text-2xl font-bold mb-4">Courses Grade</h2>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="col-span-2">
                        <div className="p-4 bg-purple-100 rounded-xl text-gray-800">
                          ...
                          <div className="mt-2">
                            🎓 Academic Update:
                            <br />5 out of 8 grades available
                          </div>
                        </div>
                      </div>
                    </div>
