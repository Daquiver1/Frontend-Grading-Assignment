    ...
    <div>
        <div className="bg-light border-right" id="sidebar-wrapper">
          <div className="sidebar-heading text-center">
             <i className="bi bi-mortarboard-fill text-primary fs-1 text-center"></i>
          </div>
          <div className="list-group">
                  ...
                  <a href="missing-grade" className="list-group-item list-group-item-action bg-blue">Missing Grade</a>
