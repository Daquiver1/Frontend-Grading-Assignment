        ...
        <div
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-white text-2xl mb-8">Explore academic excellence with the University of Ghana Grade System – your number one platform for tracking grades, managing coursework, and gaining valuable insights. Elevate your educational journey effortlessly!</p>
              <Link to="/Login">
