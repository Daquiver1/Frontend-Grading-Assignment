...
const Contact = () => {
    ...
    return(
      <>
        ...
        <div className="md:flex flex flex-col bg-gray-300 hover:bg-green-200 duration-75 cursor-pointer text-blue-700 font-sans text-semibold rounded-lg shadow-xl min-h-[50px] ml-5 mt-10">
      ...
      <button onClick={() => window.location.href='mailto:parmah54@gmail.com'}  className="bg-blue-700 text-white font-semibold text-center rounded hover:bg-white hover:text-blue-700 ">
        ...
        <li>Email: <span className="text-black">dwumf22@gmail.com </span> </li>
        <li>Tel: <span className="text-black">(+233) 530-242-985 </span> </li>
      </ul>

      
      <button onClick={() => window.location.href='mailto:dwumfour22@gmail.com'}  className="bg-blue-700 text-white font-semibold text-center rounded hover:bg-white hover:text-blue-700 md:items-end">
        Send Email</button>
        ...
        <li>Email: <span className="text-black">micha450@gmail.com </span> </li>
      ...
      <ul className="p-[15px]" >
        ...
        <li>Email: <span className="text-black">bernar1@gmail.com </span> </li>
      ...
      <div className=" md:flex flex flex-col font-bold  bg-gray-300 text-blue-700  hover:bg-green-200 duration-75 cursor-pointer font-sans text-semibold rounded-lg shadow-xl min-h-[50px] ml-5 mr-5 mt-20 ">
