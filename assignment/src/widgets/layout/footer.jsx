...
Footer.defaultProps = {
  ...
  menus: [
    {
      name: "useful links",
      items: [
        { name: "Dashboard", path: "https://www.creative-tim.com/presentation" },
        { name: "Grade Report", path: "https://www.creative-tim.com/blog" },
        { name: "Missing Grade Report", path: "https://www.creative-tim.com/blog" },
      ],
    },
    {
  ...
  copyright: (
    <>
      Copyright © {year} Grade Report System{" "}
    </>
  ),
};
